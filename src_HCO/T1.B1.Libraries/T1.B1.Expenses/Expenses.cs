    ...
    public class Expenses
    {
        ...
        public static List<projectInfo> getProjectList()
        {
            ...
            try
            {
                ...
                objProjectService = (ProjectsService)objCmpService.GetBusinessService(SAPbobsCOM.ServiceTypes.ProjectsService);
        ...
        public static List<costCenterInfo> getProfitCenterList()
        {
            ...
            try
            {
                ...
                objCmpService = MainObject.Instance.B1Company.GetCompanyService();
                objProfitCenterService = (ProfitCentersService)objCmpService.GetBusinessService(SAPbobsCOM.ServiceTypes.ProfitCentersService);
                ...
                for (int i = 0; i < objProfitCenterList.Count; i++)
                {
                    ...
                    SAPbobsCOM.ProfitCenterParams objTemp = (ProfitCenterParams)objProfitCenterService.GetDataInterface(SAPbobsCOM.ProfitCentersServiceDataInterfaces.pcsProfitCenterParams);
        ...
        public static List<dimensionInfo> getDimensionsList()
        {
            ...
            try
            {
                ...
                objCmpService = MainObject.Instance.B1Company.GetCompanyService();
                objPDimensionsService = (DimensionsService)objCmpService.GetBusinessService(SAPbobsCOM.ServiceTypes.DimensionsService);
                ...
                for (int i = 0; i < objDimensionsList.Count; i++)
                {
                    ...
                    SAPbobsCOM.DimensionParams objTemp = (DimensionParams)objPDimensionsService.GetDataInterface(SAPbobsCOM.DimensionsServiceDataInterfaces.dsDimensionParams);
        ...
        public static bool isMultipleDimension()
        {
            ...
            try
            {
                ...
                objRcordSet = (Recordset)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
                objRcordSet.DoQuery(strSQL);
                if (objRcordSet.RecordCount > 0)
                {
                    strResult = objRcordSet.Fields.Item(0).Value.ToString();
        ...
        public static void openConceptsForm(SAPbouiCOM.MenuEvent pVal)
        {
            ...
            try
            {
                MainObject.Instance.B1Application.OpenForm(SAPbouiCOM.BoFormObjectEnum.fo_UserDefinedObject, "HCO_T1EXP100", "");
        ...
        public static void loadBPNameCFL(SAPbouiCOM.Form objForm, SAPbouiCOM.ItemEvent pVal)
        {
            try
            {
                ...
                {
                    SAPbouiCOM.DBDataSource variable5 = objForm.DataSources.DBDataSources.Item("@HCO_T1EXP101");
                    variable5.SetValue("U_RELPARNAME", variable5.Offset, objDT.GetValue("Name", 0).ToString());
        ...
        public static void openExpenseTypeForm(SAPbouiCOM.MenuEvent pVal)
        {
            ...
            try
            {
                MainObject.Instance.B1Application.OpenForm(SAPbouiCOM.BoFormObjectEnum.fo_UserDefinedObject, "HCO_T1EXP200", "");
        ...
        public static void openExpenseRequestForm(SAPbouiCOM.MenuEvent pVal)
        {
            ...
            try
            {
                SAPbouiCOM.Form objForm = MainObject.Instance.B1Application.OpenForm(SAPbouiCOM.BoFormObjectEnum.fo_UserDefinedObject, "HCO_T1EXP600", "");
        ...
        public static void configureExpenseRequestFOrm(string FormUID, bool ReloadCombos)
        {
            ...
            try
            {
                if (FormUID.Trim().Length > 0)
                {
                    ...
                    if (ReloadCombos)
                    {
                        objCombo = (ComboBox)objForm.Items.Item("Item_2").Specific;
                        objCombo.ValidValues.LoadSeries("HCO_T1EXP600", SAPbouiCOM.BoSeriesMode.sf_Add);


                        objEdit = (EditText)objForm.Items.Item("1_U_E").Specific;
                    ...
                    if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                    {
                        ...
                        if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                        {
                            ...
                            {
                                oDS = objForm.DataSources.DBDataSources.Item("@HCO_T1EXP600");
                    ...
                    if (ReloadCombos)
                    {
                        ...
                        if (!isMultiDim)
                        {
                            objCombo = (ComboBox)objForm.Items.Item("Item_6").Specific;
                            ...
                            foreach (dimensionInfo oDIM in objDimList)
                            {
                                switch (oDIM.DimentionCode)
                                {
                                    case 1:
                                        if (oDIM.isActive)
                                        {
                                            objCombo = (ComboBox)objForm.Items.Item("Item_7").Specific;
                                            for (int i = 0; i < objCombo.ValidValues.Count; i++)
                                            {
                                                objCombo.ValidValues.Remove(0, SAPbouiCOM.BoSearchKey.psk_Index);
                                            }
                                            ...
                                            objStatic = (StaticText)objForm.Items.Item("27_U_S").Specific;
                                    ...
                                    case 2:
                                        if (oDIM.isActive)
                                        {
                                            objCombo = (ComboBox)objForm.Items.Item("Item_8").Specific;
                                            for (int i = 0; i < objCombo.ValidValues.Count; i++)
                                            {
                                                objCombo.ValidValues.Remove(0, SAPbouiCOM.BoSearchKey.psk_Index);
                                            }
                                            ...
                                            objStatic = (StaticText)objForm.Items.Item("28_U_S").Specific;
                                            objStatic.Caption = oDIM.DimensionName;
                                    ...
                                    case 3:
                                        if (oDIM.isActive)
                                        {
                                            objCombo = (ComboBox)objForm.Items.Item("Item_9").Specific;
                                            for (int i = 0; i < objCombo.ValidValues.Count; i++)
                                            {
                                                objCombo.ValidValues.Remove(0, SAPbouiCOM.BoSearchKey.psk_Index);
                                            }
                                            ...
                                            objStatic = (StaticText)objForm.Items.Item("29_U_S").Specific;
                                            objStatic.Caption = oDIM.DimensionName;
                                    ...
                                    case 4:
                                        if (oDIM.isActive)
                                        {
                                            objCombo = (ComboBox)objForm.Items.Item("Item_10").Specific;
                                            for (int i = 0; i < objCombo.ValidValues.Count; i++)
                                            {
                                                objCombo.ValidValues.Remove(0, SAPbouiCOM.BoSearchKey.psk_Index);
                                            }
                                            ...
                                            objStatic = (StaticText)objForm.Items.Item("30_U_S").Specific;
                                            objStatic.Caption = oDIM.DimensionName;
                                    ...
                                    case 5:
                                        if (oDIM.isActive)
                                        {
                                            objCombo =(ComboBox) objForm.Items.Item("Item_11").Specific;
                                            for (int i = 0; i < objCombo.ValidValues.Count; i++)
                                            {
                                                objCombo.ValidValues.Remove(0, SAPbouiCOM.BoSearchKey.psk_Index);
                                            }
                                            ...
                                            objStatic = (StaticText)objForm.Items.Item("31_U_S").Specific;
                                            objStatic.Caption = oDIM.DimensionName;
                        ...
                        #endregion
                        #region Projects
                        objCombo = (ComboBox)objForm.Items.Item("Item_0").Specific;
                        for (int i = 0; i < objCombo.ValidValues.Count; i++)
                        {
                            objCombo.ValidValues.Remove(0, SAPbouiCOM.BoSearchKey.psk_Index);
                        }
        ...
        internal static void GetTotal_Desembolso(ItemEvent pVal)
        {
            SAPbouiCOM.Form oForm = (SAPbouiCOM.Form)MainObject.Instance.B1Application.Forms.Item(pVal.FormUID);
            SAPbouiCOM.DataTable oDT_SAP = (SAPbouiCOM.DataTable) oForm.DataSources.DataTables.Item("DT_DOCS");

            var dt = T1.B1.Base.UIOperations.FormsOperations.SapDataTableToDotNetDataTable(oDT_SAP.SerializeAsXML(BoDataTableXmlSelect.dxs_All));

            oForm.DataSources.UserDataSources.Item("UD_TOTAL").Value = ((double)dt.Compute("SUM(Valor)", "Desembolsar = 'Y'")).ToString(CultureInfo.InvariantCulture);
        }
        ...
        static public void loadPendingAppovedRequestForm()
        {
            ...
            try
            {
                ...
                objParams.XmlData = ExpensesRes.HCO_ApproveRequestsForm;
                objParams.FormType = "HCO_REQAPR";
                objForm = MainObject.Instance.B1Application.Forms.AddEx(objParams);
                objDT = objForm.DataSources.DataTables.Item("HCO_RELIST");
                ...
                #region Format Grid
                objGrid = (Grid)objForm.Items.Item("aprGrid").Specific;
                ...
                oEditTExt.LinkedObjectType = "HCO_T1EXP600";
        ...
        static public void updateRequestStatus(SAPbouiCOM.ItemEvent pVal)
        {
            ...
            try
            {
                ...
                if (objDT.Rows.Count > 0)
                {
                    ...
                    objGeneralService = objCompanyService.GetGeneralService("HCO_T1EXP600");
                    objGeneralData = (GeneralData)objGeneralService.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralData);
                    
                    T1.B1.Base.UIOperations.Operations.startProgressBar("Procesando...", objDT.Rows.Count);
                    for (int i = 0; i < objDT.Rows.Count; i++)
                    {
                        int strDocEntry = int.Parse(objDT.GetValue(1, i).ToString());
                        string strChecked = objDT.GetValue(0, i).ToString();
                        if (strChecked.Trim().ToUpper() == "Y")
                        {
                            objSearch = (GeneralDataParams)objGeneralService.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
        ...
        static public void loadPaymentForm()
        {
            ...
            try
            {
                objParams = (FormCreationParams) MainObject.Instance.B1Application.CreateObject(SAPbouiCOM.BoCreatableObjectType.cot_FormCreationParams);
                objParams.UniqueID = Guid.NewGuid().ToString().Substring(1, 20);
                objParams.XmlData = ExpensesRes.HCOEXP_Payment;
                ...
                #region Format Grid
                objGrid = (Grid)objForm.Items.Item("gridDocs").Specific;
            ...
            try
            {
                ...
                if (clearFilter)
                {
                    ...
                    if(oEvent.SelectedObjects != null && oEvent.SelectedObjects.Rows.Count == 1)
                    {
                        ...
                        oDS.Value = oEvent.SelectedObjects.GetValue("AcctCode", 0).ToString();
                    }
        ...
        public static void addPaymentDocument(SAPbouiCOM.ItemEvent pVal)
        {
            ...
            try
            {
                ...
                if(objDocs != null)
                {
                    ...
                    SAPbobsCOM.SBObob objTemp = (SBObob)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoBridge);
                    SAPbobsCOM.Recordset objRS = objTemp.Format_StringToDate(objPaymentDate.Value);
                    dtPaymentDate = DateTime.Parse( objRS.Fields.Item(0).Value.ToString());// Convert.ToDateTime(objPaymentDate.Value,CultureInfo.InvariantCulture);
                    ...
                    {
                        strChecked = objDocs.GetValue(0, i).ToString();
                        if (strChecked.Equals("N")) continue;

                        intRequestDocEntry = int.Parse(objDocs.GetValue(1, i).ToString());
                        {
                            objFilterParams = (GeneralDataParams)objRequest.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                            ...
                            {
                                strExpenseType = objRequestData.GetProperty("U_EXPTYPE").ToString();
                                strProject = objRequestData.GetProperty("U_PROJECT").ToString();
                                strDIM1 = objRequestData.GetProperty("U_DIM1").ToString();
                                strDIM2 = objRequestData.GetProperty("U_DIM2").ToString();
                                strDIM3 = objRequestData.GetProperty("U_DIM3").ToString();
                                strDIM4 = objRequestData.GetProperty("U_DIM4").ToString();
                                strDIM5 = objRequestData.GetProperty("U_DIM5").ToString();
                                strRequestRemark = objRequestData.GetProperty("Remark").ToString();
                                dbRequestedValue = double.Parse(objRequestData.GetProperty("U_VALUE").ToString());
                                //int strNumber = int.Parse(objDocs.GetValue(6, i).ToString());
                                //if (strNumber > 0)
                                //{
                                ...
                                //{
                                    intPayNumber = -1;
                                //}
                                //DateTime objPayDate = objDocs.GetValue(5, i) == null? new DateTime(2010,1,1): DateTime.Parse(objDocs.GetValue(5, i).ToString());
                                ...
                                for (int j=0; j < objRequestRelatedParties.Count; j++)
                                {
                                    ...
                                    strRelatedPartiesCode = objRequestRelatedPartiesData.GetProperty("U_TERRELA").ToString();
                                ...
                                if(strRelatedPartiesCode.Trim().Length > 0)
                                {
                                    ...
                                    objFilterParams = (GeneralDataParams)objRelatedParties.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                                    ...
                                    {
                                        strCardCode = objRelatedPartiesData.GetProperty("Code").ToString();
                                        strCardName = objRelatedPartiesData.GetProperty("Name").ToString();
                                    }
                                }
                                #endregion

                                objRequestType = objCompanyService.GetGeneralService(Settings._Main.ExpenseTypeUDO);
                                objFilterParams = (GeneralDataParams)objRequestType.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                                ...
                                {
                                    strRequestTypeAccount = objRequestTypeData.GetProperty("U_MAINACCT").ToString();
                                }
                                else
                                {
                                    _Logger.Error("HCO: Could not retrieve Expense Type Data: " + strExpenseType);
                                }
                                ...
                                if (blIsAssociated)
                                {
                                    ...
                                    objPayment = (Payments)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oVendorPayments);
                                ...
                                else
                                {
                                    ...
                                    objPayment.TaxDate = dtPaymentDate;
                                    objPayment.Remarks = strRequestRemark + ". " + strPaymentRemarks;
                                    objPayment.UserFields.Fields.Item("U_HCO_RELPAR").Value = objPayment.CardCode = strCardCode;
                                    objPayment.AccountPayments.UserFields.Fields.Item("U_HCO_RELPAR").Value = objPayment.CardCode = strCardCode;
                                    if (intPayNumber > 0)
                                    {
                                        objPayment.HandWritten = SAPbobsCOM.BoYesNoEnum.tYES;
                                        objPayment.DocNum = intPayNumber;
                                    ...
                                    if (blIsAssociated)
                                    {
                                            ...
                                            )
                                        {
                                            ...
                                            if (objPayment.GetByKey(Convert.ToInt32(strLastKey)))
                                            {
                                                ...
                                                {
                                                    int TransId = int.Parse(objRS.Fields.Item(0).Value.ToString());
    ...
    ;
        ...
        public static void changeRequestStatus(SAPbouiCOM.BusinessObjectInfo BusinessObjectInfo)
        {
            ...
            try
            {
                ...
                objFilter = (GeneralDataParams)objLegalizationObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                ...
                objRequestObject = objCompanyService.GetGeneralService("HCO_T1EXP600");
                objFilter = (GeneralDataParams)objRequestObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
        ...
        public static void deleteRowAfter(string FormUID)
        {
            ...
            try
            {
                ...
                objForm = MainObject.Instance.B1Application.Forms.Item(FormUID);
                oDBDS = objForm.DataSources.DBDataSources.Item("@HCO_T1EXP400");
                oDBDSLines = objForm.DataSources.DBDataSources.Item("@HCO_T1EXP401");
                ...
                if (objFormCache != null && objFormCache.DocumentLines != null)
                {
                    ...
                    if (strValues[0] == FormUID)
                    {
                        ...
                        {
                            MainObject.Instance.B1Application.SetStatusBarMessage("HCO Error al eleimnar la fila de la legalización. Cierre el formulario sin guardar e intentelo de nuevo. ", SAPbouiCOM.BoMessageTime.bmt_Short, true);
                        }

                    }
                    else
                    {
                        MainObject.Instance.B1Application.SetStatusBarMessage("HCO: No se pudo recuperar la información de la legalización. Por favor ciere el formulario e intentelo de nuevo. ", SAPbouiCOM.BoMessageTime.bmt_Short, true);
                    }
                }
            }
            catch(Exception er)
        ...
        public static void openLegalizationForm(SAPbouiCOM.MenuEvent pVal)
        {
            ...
            try
            {
                SAPbouiCOM.Form objForm = MainObject.Instance.B1Application.OpenForm(SAPbouiCOM.BoFormObjectEnum.fo_UserDefinedObject, "HCO_T1EXP400", "");
            ...
            try
            {
                ...
                if (clearFilter)
                {
                    ...
                    if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                    {
                        ...
                        {
                            intExpenseDocEntry = int.Parse(oEvent.SelectedObjects.GetValue("DocEntry", 0).ToString());
                    ...
                    if (clearFilter)
                    {
                        ...
                        if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE || objForm.Mode == SAPbouiCOM.BoFormMode.fm_UPDATE_MODE)
                        {
                            ...
                            if (oEvent.SelectedObjects != null)
                            {
                                ...
                                strConceptCode = oEvent.SelectedObjects.GetValue("Code", 0).ToString();
                                ...
                                if (objConcept != null)
                                {
                                    ...
                                    oDBLinesDS = objForm.DataSources.DBDataSources.Item("@HCO_T1EXP401");
                    ...
                    else
                    {
                        ...
                        if (strType.Trim().Length > 0)
                        {
                            ...
                            if (objRS.RecordCount > 0)
                            {
                                ...
                                while (!objRS.EoF)
                                {
                                    string steCode = objRS.Fields.Item("Code").Value.ToString();
                                    objCondition = objConditions.Add();
                                    if (intTotal > 1)
                                    {
        ...
        public static void filterThirdPartyConceptsUDO(SAPbouiCOM.ItemEvent pVal, bool clearFilter, out bool BubbleEvent)
        {
            ...
            try
            {
                ...
                if (objLegalizationFormCache != null)
                {
                    ...
                    {
                        objCFL.SetConditions(null);
                        objMatrix = (Matrix)objForm.Items.Item(pVal.ItemUID).Specific;
                        objMatrix.FlushToDataSource();
                    }
                    else
                    {
        ...
        public static void configureLegalizationForm(string FormUID, bool ReloadCombos)
        {
            ...
            try
            {
                if (FormUID.Trim().Length > 0)
                {
                    ...
                    {
                        objCombo = (ComboBox)objForm.Items.Item("Item_2").Specific;
                        objCombo.ValidValues.LoadSeries("HCO_T1EXP400", SAPbouiCOM.BoSeriesMode.sf_Add);
        ...
        public static double getExpenseValue(int DocEntry)
        {
            ...
            try
            {
                ...
                objFilter = (GeneralDataParams)objExpenseObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                objFilter.SetProperty("DocEntry", DocEntry);
                objExpenseInfo = objExpenseObject.GetByParams(objFilter);
                dbTotal = double.Parse(objExpenseInfo.GetProperty("U_VALUE").ToString());
        ...
        public static Tuple<string,string> getExpenseTypeInfo(int DocEntry)
        {
            ...
            try
            {
                ...
                objFilter.SetProperty("DocEntry", DocEntry);
                objExpenseInfo = objExpenseObject.GetByParams(objFilter);
                strExpenseType = objExpenseInfo.GetProperty("U_EXPTYPE").ToString();

                objExpenseTypeObject = objCompanyService.GetGeneralService(Settings._Main.ExpenseTypeUDO);
                objFilter = (GeneralDataParams)objExpenseTypeObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                objFilter.SetProperty("Code", strExpenseType);
                objExpenseTypeInfo = objExpenseTypeObject.GetByParams(objFilter);
                strConceptType = objExpenseTypeInfo.GetProperty("U_EXPTYPE").ToString();
        ...
        private static LegalizationFormCache getLegalizationInfo(int intLegalizationDocEntry)
        {
            ...
            try
            {
                ...
                objLegalizationInfo = objLegalizationObject.GetByParams(objFilter);
                objLegalizationFormCache.DocNum = int.Parse(objLegalizationInfo.GetProperty("DocNum").ToString());
                objLegalizationFormCache.Series = int.Parse(objLegalizationInfo.GetProperty("Series").ToString());
                ...
                objLegalizationFormCache.expense = getExpenseInfo(intExpenseDocEntry);
                objLegalizationFormCache.ExpenseValue = double.Parse(objLegalizationInfo.GetProperty("U_VALUE").ToString());
                objLegalizationFormCache.DocumentLines = new List<ConceptLines>();
                objLegalizationFormCache.isPosted = objLegalizationInfo.GetProperty("U_ISPOSTED").ToString() == "Y" ? true : false;
                objLegalizationFormCache.TotalValue = double.Parse(objLegalizationInfo.GetProperty("U_TOTVALUE").ToString());
                objLegalizationFormCache.PostingDate = DateTime.Parse(objLegalizationInfo.GetProperty("U_POSTDATE").ToString());
                objLegalizationFormCache.JournalEntry = int.Parse(objLegalizationInfo.GetProperty("U_JEENTRY").ToString());
                objLegalizationFormCache.remarks = objLegalizationInfo.GetProperty("Remark").ToString();


                objLegalizationLines = objLegalizationInfo.Child("HCO_T1EXP401");
                for(int i=0; i < objLegalizationLines.Count; i++)
                {
                    objLegalizationLineInfo = objLegalizationLines.Item(i);
                    ConceptLines objConceptLine = new ConceptLines();
                    string strConcept = objLegalizationLineInfo.GetProperty("U_CONCEPT").ToString();
                    if (strConcept.Trim().Length > 0)
                    {
                        objConceptLine.ConceptCode = objLegalizationLineInfo.GetProperty("U_CONCEPT").ToString();
                        objConceptLine.Date = DateTime.Parse(objLegalizationLineInfo.GetProperty("U_DATE").ToString());
                        objConceptLine.Description = objLegalizationLineInfo.GetProperty("U_DESCRIPTION").ToString();
                        objConceptLine.DIM1 = objLegalizationLineInfo.GetProperty("U_DIM1").ToString();
                        objConceptLine.DIM2 = objLegalizationLineInfo.GetProperty("U_DIM2").ToString();
                        objConceptLine.DIM3 = objLegalizationLineInfo.GetProperty("U_DIM3").ToString();
                        objConceptLine.DIM4 = objLegalizationLineInfo.GetProperty("U_DIM4").ToString();
                        objConceptLine.DIM5 = objLegalizationLineInfo.GetProperty("U_DIM5").ToString();
                        objConceptLine.LineTotal = double.Parse(objLegalizationLineInfo.GetProperty("U_LINETOT").ToString());
                        objConceptLine.ProfitCenter = objLegalizationLineInfo.GetProperty("U_DIM1").ToString();
                        objConceptLine.Project = objLegalizationLineInfo.GetProperty("U_PROJECT").ToString();
                        objConceptLine.ThirdParty = objLegalizationLineInfo.GetProperty("U_THIRDPARTY").ToString();
                        objConceptLine.TotalBeforeTaxes = double.Parse(objLegalizationLineInfo.GetProperty("U_VALUE").ToString());
                        objConceptLine.VAT = double.Parse(objLegalizationLineInfo.GetProperty("U_VAT").ToString());
                        objConceptLine.WHTax = double.Parse(objLegalizationLineInfo.GetProperty("U_WHTAX").ToString());
        ...
        private static Expense getExpenseInfo(int intExpenseDocEntry)
        {
            ...
            try
            {
                ...
                objExpenseInfo = objExpenseObject.GetByParams(objFilter);
                objExpense.docNum = int.Parse(objExpenseInfo.GetProperty("DocNum").ToString());
                objExpense.endDate = DateTime.Parse( objExpenseInfo.GetProperty("U_ENDDATE").ToString());
                objExpense.expectedValue = double.Parse(objExpenseInfo.GetProperty("U_VALUE").ToString());

                ExpenseCostAccounting oCostAcc = new ExpenseCostAccounting();
                oCostAcc.CostCenter = objExpenseInfo.GetProperty("U_COSTCENTER").ToString();
                oCostAcc.DIM1 = objExpenseInfo.GetProperty("U_DIM1").ToString();
                oCostAcc.DIM2 = objExpenseInfo.GetProperty("U_DIM2").ToString();
                oCostAcc.DIM3 = objExpenseInfo.GetProperty("U_DIM3").ToString();
                oCostAcc.DIM4 = objExpenseInfo.GetProperty("U_DIM4").ToString();
                oCostAcc.DIM5 = objExpenseInfo.GetProperty("U_DIM5").ToString();
                oCostAcc.Project = objExpenseInfo.GetProperty("U_PROJECT").ToString();
                
                objExpense.expenseCostAccounting = oCostAcc;
                objExpense.expenseResponsableThirdParty = new List<ExpenseResponsableThirdParty>();

                string strExpenseType = objExpenseInfo.GetProperty("U_EXPTYPE").ToString();

                objExpense.expnseType = getExpenseType(strExpenseType);
                objExpense.legalizedValue= double.Parse(objExpenseInfo.GetProperty("U_REALVALUE").ToString());
                objExpense.remark = objExpenseInfo.GetProperty("Remark").ToString();
                objExpense.series = int.Parse(objExpenseInfo.GetProperty("Series").ToString());
                objExpense.startDate = DateTime.Parse(objExpenseInfo.GetProperty("U_STARTDATE").ToString());
                objExpense.status = objExpenseInfo.GetProperty("U_STATUS").ToString();


                objThirdPartyLines = objExpenseInfo.Child("HCO_T1EXP601");
                for (int i = 0; i < objThirdPartyLines.Count; i++)
                {
                    ...
                    objThirdParty.CardCode = objExpenseThirdPartyInfo.GetProperty("U_TERRELA").ToString();
        ...
        private static ExpenseType getExpenseType(string strExpenseType)
        {
            ...
            try
            {
                ...
                objFilter.SetProperty("Code", strExpenseType);
                objExpenseTypeInfo = objExpenseTypeObject.GetByParams(objFilter);
                objExpenseType.account = objExpenseTypeInfo.GetProperty("U_MAINACCT").ToString();
                objExpenseType.expenseClass = objExpenseTypeInfo.GetProperty("U_EXPTYPE").ToString();
                objExpenseType.name = objExpenseTypeInfo.GetProperty("Name").ToString();
                objExpenseType.remark = objExpenseTypeInfo.GetProperty("U_COMMENT").ToString();
            }
            catch (Exception er)
            {
                _Logger.Error("", er);
        ...
        public static void serializeConceptInformation(string strCode)
        {
            ...
            try
            {
                ...
                objFilter = (GeneralDataParams)objConceptObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
        ...
        public static Concept getConceptInformation(string strCode)
        {
            ...
            try
            {
                ...
                objConcept.Account = objConceptInfo.GetProperty("U_ACCTCODE").ToString();
                objConcept.Code = objConceptInfo.GetProperty("Code").ToString();
                objConcept.Description = objConceptInfo.GetProperty("U_DESCRIP").ToString();
                objConcept.Name = objConceptInfo.GetProperty("Name").ToString();
                ...
                objThirdpartyChild = objConceptInfo.Child("HCO_T1EXP101");
                for(int i=0; i < objThirdpartyChild.Count; i++)
                {
                    ConceptThirdParty objTP = new ConceptThirdParty();
                    objTP.Code = objThirdpartyChild.Item(i).GetProperty("U_RELPARCODE").ToString();
                ...
                objWHTaxChild = objConceptInfo.Child("HCO_T1EXP102");
                for (int i = 0; i < objWHTaxChild.Count; i++)
                {
                    ConceptWHTax objWHtax = new ConceptWHTax();
                    objWHtax.Code = objWHTaxChild.Item(i).GetProperty("U_WTCODE").ToString();
                ...
                objVATChild = objConceptInfo.Child("HCO_T1EXP103");
                for (int i = 0; i < objVATChild.Count; i++)
                {
                    ConceptVAT objVAT = new ConceptVAT();
                    objVAT.Code = objVATChild.Item(i).GetProperty("U_TAXCODE").ToString();
                ...
                objExpenseClassChild = objConceptInfo.Child("HCO_T1EXP104");
                for (int i = 0; i < objExpenseClassChild.Count; i++)
                {
                    string strExpenseClass = objExpenseClassChild.Item(i).GetProperty("U_EXPTYPE").ToString();
        ...
        public static void refreshLineInfo(SAPbouiCOM.ItemEvent pVal)
        {
            ...
            try
            {
                ...
                if (intExpenseDocEntry > 0)
                {
                    objLegalizationFormCache = getLegalizationInformation(intDocEntry, intExpenseDocEntry, pVal.FormUID, true);
                }
        ...
        public static void refreshFormValues(SAPbouiCOM.ItemEvent pVal, Tuple<string, string, int> tLastGotFocusColumn)
        {
            ...
            {
                objForm = MainObject.Instance.B1Application.Forms.Item(pVal.FormUID);
                objDBDS = objForm.DataSources.DBDataSources.Item("@HCO_T1EXP400");
                ...
                if (objLegalizationFormCache != null)
                {
                    ...
                    intRowNumber = tLastGotFocusColumn.Item3-1;
                        ...
                        objDBDSLines = objForm.DataSources.DBDataSources.Item("@HCO_T1EXP401");

                            dbRowValue = double.Parse(objDBDSLines.GetValue("U_VALUE", intRowNumber).ToString(),CultureInfo.InvariantCulture);
                        ...
                        double dbVATTotal = 0;
                            ...
                            for (int i = 0; i < objLegalizationFormCache.DocumentLines.Count; i++)
                            {
                                ...
                                if (objLines.FormLineNum == pVal.Row)
                                {
                                    ...
                                    {
                                        SAPbobsCOM.SalesTaxCodes objVAT = (SalesTaxCodes) MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oSalesTaxCodes);
                                    ...
                                    {
                                        SAPbobsCOM.WithholdingTaxCodes objWHT = (WithholdingTaxCodes)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oWithholdingTaxCodes);
                ...
                if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE || objForm.Mode == SAPbouiCOM.BoFormMode.fm_UPDATE_MODE)
                {
                    ...
                    if (!isMultiDim)
                    {
                        ...
                        if (intNumberOfRows > 0)
                        {
                            ...
                            objCombo = (ComboBox)objColumn.Cells.Item(intNumberOfRows).Specific;
                            for (int i = 0; i < objCombo.ValidValues.Count; i++)
                            {
                                objCombo.ValidValues.Remove(0, SAPbouiCOM.BoSearchKey.psk_Index);
                            }
        ...
        private static void updateVisualizarionString(string FormUID, string ColumnID, string ItemID, string NewValue)
        {
            ...
            try
            {
                objDynamicStrings = (DynamicSystemStrings)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oDynamicSystemStrings);
        ...
        public static void postLegalization(SAPbouiCOM.ItemEvent pVal)
        {
            ...
            try
            {
                ...
                if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
                {
                    ...
                    objCompanyService = MainObject.Instance.B1Company.GetCompanyService();
                    objLegalizationObject = objCompanyService.GetGeneralService(Settings._Main.LegalizationUDO);
                    oFilter = (GeneralDataParams)objLegalizationObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                    ...
                    if (objLegalizationInfo != null && objFormCache != null)
                    {
                        ...
                        objMainJE = (JournalEntries)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oJournalEntries);
                        ...
                        foreach (ConceptLines objLines in objFormCache.DocumentLines)
                        {
                            if (objLines.ConceptCode.Trim().Length > 0)
                            {
                                if (objLines.Concept.ValidWHTax != null && objLines.Concept.ValidWHTax.Count > 0)
                                {
                                    ...
                                    objAdditionalJE = (JournalEntries)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oJournalEntries);
                                    ...
                                    //objAdditionalJE.Lines.Debit = dbSys;
                                    ...
                                    if (dbDifference > 0)
                                    {
                                        ...
                                        objAdditionalJE.Lines.Debit = Math.Abs(dbDifference);
                                    ...
                                    else if (dbDifference < 0)
                                    {
                                        objAdditionalJE.Lines.Add();
                                        objAdditionalJE.Lines.AccountCode = Settings._MainPettyCash.SysCurrDeviationAccount;
                                        objAdditionalJE.Lines.Credit = Math.Abs(dbDifference);
                                    ...
                                    string strXML = objAdditionalJE.GetAsXML();
                        ...
                        else
                        {
                            ...
                            foreach (SAPbobsCOM.JournalEntries objJEItem in objAllJE)
                            {
                                ...
                                if (intResult == 0)
                                {
                                    ...
                                    SAPbobsCOM.JournalEntries oTemp = (JournalEntries)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oJournalEntries);
                            ...
                            if (blResult)
                            {
                                ...
                                objLegalizationJELines = objLegalizationInfo.Child("HCO_T1EXP403");
                                
                                foreach(int intJE in JETransIdListE)
                                {
                                    SAPbobsCOM.JournalEntries objJEItem = (JournalEntries)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oJournalEntries);
                                ...
                                objRequestObject = objCompanyService.GetGeneralService("HCO_T1EXP600");
                                oFilter = (GeneralDataParams)objRequestObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
