    ...
    public class Settings
    {
        ...
        public class Main : Westwind.Utilities.Configuration.AppConfiguration
        {
            public Main()
            {
                logLevel = "Debug";
                recreateMenu = false;
                ConceptUDOFormType = "UDO_FT_HCO_T1EXP100";
                ExpenseTypeUDOFormType = "UDO_FT_HCO_T1EXP200";
                ExpenseRequestUDoFormType = "UDO_FT_HCO_T1EXP600";
                ExpenseRequestFormLastId = "ExpenseRequestFormLastId";
                DefaultCreateStatus = "BORRADOR";
                ExpenseTypeClasificatioonUDOFormType = "HCO_T1EXP500";
                ApprovedStatusValue = "APROBADA";
                PaymentValidValues = "'APROBADA'";
                PaymentFormType = "HCO_EXPPAY001";
                ExpenseTypeUDO = "HCO_T1EXP200";
                ExpenseUDO = "HCO_T1EXP600";
                ExpenseRequestRelatedPartiesChild = "HCO_T1EXP601";
                RelatedPartyUDO = "HCO_FRP1100";
                PaymentStatusValue = "DESEMBOLSADA";
                LegalizationFormLastId = "LegalizationFormLastId";
                LegalizationRequestUDoFormType = "UDO_FT_HCO_T1EXP400";
                ConceptUDO = "HCO_T1EXP100";
                LegalizationUDO = "HCO_T1EXP400";
        ...
        public class SQL : Westwind.Utilities.Configuration.AppConfiguration
        {
            public SQL()
            {
                ...
                getApprovedRequests = "select 'N' as \"Aprobar\" ,\"DocEntry\" as \"Documento\",\"U_STARTDATE\" as \"Inicio\",U_ENDDATE as \"Finalización\",\"U_VALUE\" as \"Valor\" from [@HCO_T1EXP600] where \"U_STATUS\" = 'DEFINITIVA'";
                getValidPaymentDocuments = "select 'N' as \"Aprobar\" ,\"DocEntry\" as \"Documento\",\"U_STARTDATE\" as \"Inicio\",U_ENDDATE as \"Finalización\",\"U_VALUE\" as \"Valor\", \"U_PAYDATE\" as \"Fecha Pago\", \"U_PAYMENT\" as \"Comprobante de Pago\", \"U_STATUS\" as \"Estado\" from [@HCO_T1EXP600] where \"U_STATUS\" in ([--ValidStatus--])";
                getJEFromPayment = "Select \"TransId\" from OVPM where \"DocEntry\" = [--DocEntry--]";
                getConceptsCode = "select \"Code\" from [@HCO_T1EXP104] where U_EXPTYPE = '[--ExpType--]'";
            }
        ...
        public class HANA : Westwind.Utilities.Configuration.AppConfiguration
        {
            public HANA()
            {
                getMultipleDimQuery = "Select \"UseMltDims\" from OADM";
                getApprovedRequests = "select 'N' as \"Aprobar\" ,\"DocEntry\" as \"Documento\",\"U_STARTDATE\" as \"Inicio\",U_ENDDATE as \"Finalización\",\"U_VALUE\" as \"Valor\" from \"@HCO_T1EXP600\" where \"U_STATUS\" = 'DEFINITIVA'";
                getValidPaymentDocuments = "select 'N' as \"Desembolsar\" ,\"DocEntry\" as \"Documento\",\"U_STARTDATE\" as \"Inicio\",U_ENDDATE as \"Finalización\",\"U_VALUE\" as \"Valor\", \"U_STATUS\" as \"Estado\" from \"@HCO_T1EXP600\" where \"U_STATUS\" in ([--ValidStatus--])";
                getJEFromPayment = "Select \"TransId\" from OVPM where \"DocEntry\" = [--DocEntry--]";
                getConceptsCode = "select \"Code\" from \"@HCO_T1EXP104\" where U_EXPTYPE = '[--ExpType--]'";
            }
