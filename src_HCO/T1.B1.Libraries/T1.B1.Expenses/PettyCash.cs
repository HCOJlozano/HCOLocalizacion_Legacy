    ...
    public class PettyCash
    {
        ...
        public static List<projectInfo> getProjectList()
        {
            ...
            try
            {
                ...
                objProjectService = (SAPbobsCOM.ProjectsService)objCmpService.GetBusinessService(SAPbobsCOM.ServiceTypes.ProjectsService);
        ...
        public static List<costCenterInfo> getProfitCenterList()
        {
            ...
            try
            {
                ...
                objCmpService = MainObject.Instance.B1Company.GetCompanyService();
                objProfitCenterService = (SAPbobsCOM.ProfitCentersService) objCmpService.GetBusinessService(SAPbobsCOM.ServiceTypes.ProfitCentersService);
                ...
                for (int i = 0; i < objProfitCenterList.Count; i++)
                {
                    ...
                    SAPbobsCOM.ProfitCenterParams objTemp = (SAPbobsCOM.ProfitCenterParams)objProfitCenterService.GetDataInterface(SAPbobsCOM.ProfitCentersServiceDataInterfaces.pcsProfitCenterParams);
        ...
        public static List<dimensionInfo> getDimensionsList()
        {
            ...
            try
            {
                ...
                objCmpService = MainObject.Instance.B1Company.GetCompanyService();
                objPDimensionsService = (SAPbobsCOM.DimensionsService)objCmpService.GetBusinessService(SAPbobsCOM.ServiceTypes.DimensionsService);
                ...
                for (int i = 0; i < objDimensionsList.Count; i++)
                {
                    ...
                    SAPbobsCOM.DimensionParams objTemp = (SAPbobsCOM.DimensionParams)objPDimensionsService.GetDataInterface(SAPbobsCOM.DimensionsServiceDataInterfaces.dsDimensionParams);
        ...
        public static bool isMultipleDimension()
        {
            ...
            try
            {
                ...
                objRcordSet = (SAPbobsCOM.Recordset)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset);
        ...
        static public void loadPettyCashPaymentForm()
        {
            ...
            try
            {
                objParams = (SAPbouiCOM.FormCreationParams)MainObject.Instance.B1Application.CreateObject(SAPbouiCOM.BoCreatableObjectType.cot_FormCreationParams);
                objParams.UniqueID = Guid.NewGuid().ToString().Substring(1, 20);
                oXML.Load(AppDomain.CurrentDomain.BaseDirectory + "\\Forms\\HCOPTC_CMPayment.srf");
                objParams.XmlData = oXML.InnerXml;
        ...
        public static void filterAccountPCPaymentForm(SAPbouiCOM.ItemEvent pVal, bool clearFilter)
        {
            ...
            try
            {
                ...
                {
                    objConditions = (SAPbouiCOM.Conditions) MainObject.Instance.B1Application.CreateObject(SAPbouiCOM.BoCreatableObjectType.cot_Conditions);
            ...
            try
            {
                ...
                if (clearFilter)
                {
                    ...
                    if (oEvent.SelectedObjects != null && oEvent.SelectedObjects.Rows.Count == 1)
                    {
                        ...
                        oDS.Value = oEvent.SelectedObjects.GetValue("Code", 0).ToString();
                    }
        ...
        public static void addPaymentDocument(SAPbouiCOM.ItemEvent pVal)
        {
            ...
            try
            {
                ...
                SAPbobsCOM.SBObob objTemp = (SAPbobsCOM.SBObob)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoBridge);
                SAPbobsCOM.Recordset objRS = objTemp.Format_StringToDate(objPaymentDate.Value);
                dtPaymentDate = Convert.ToDateTime(objRS.Fields.Item(0).Value, CultureInfo.InvariantCulture);
                    ...
                    )
                {
                    ...
                    objFilterParams = (GeneralDataParams)objPettyCash.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                    objFilterParams.SetProperty("Code", strPettyCash);
                    objPettyCashData = objPettyCash.GetByParams(objFilterParams);
                    strPettyCashAccount = objPettyCashData.GetProperty("U_PCACCOUNT").ToString();
                    strControlAccount = objPettyCashData.GetProperty("U_CTRLACCT").ToString();
                    dbValue = double.Parse(objPettyCashData.GetProperty("U_VALUE").ToString());
                    strResponsable = objPettyCashData.GetProperty("U_TERRELA").ToString();
                    ...
                    if (strResponsable.Trim().Length > 0)
                    {
                        ...
                        {
                            strCardCode = objRelatedPartiesData.GetProperty("U_CARDCODE").ToString();
                            strCardName = objRelatedPartiesData.GetProperty("U_LEGALNAME").ToString();

                            #region Asiento Contable de Apertura

                            objJE = (JournalEntries)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oJournalEntries);
                            ...
                            objJE.Lines.UserFields.Fields.Item("U_HCO_RELPAR").Value = strResponsable;
                            objJE.Lines.Add();
                            if (blIsAssociated)
                            {
                            ...
                            else
                            {
                                ...
                                if (intResult == 0)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        MainObject.Instance.B1Application.SetStatusBarMessage("HCO: " + strMessage, SAPbouiCOM.BoMessageTime.bmt_Short, true);
                                    }
                                }
                                else
                                {
                    ...
                    {
                        objForm.Close();
                        MainObject.Instance.B1Application.SetStatusBarMessage("HCO: La apertura de la caja se realizó con éxito.", SAPbouiCOM.BoMessageTime.bmt_Short, false);
                    }
                    else
                    {
                        MainObject.Instance.B1Application.SetStatusBarMessage("HCO: " + strMessage, SAPbouiCOM.BoMessageTime.bmt_Short, true);
        ...
        public static void loadBPNameCFL(SAPbouiCOM.Form objForm, SAPbouiCOM.ItemEvent pVal)
        {
            try
            {
                ...
                {
                    SAPbouiCOM.DBDataSource variable5 = objForm.DataSources.DBDataSources.Item("@HCO_T1PTC202");
                    variable5.SetValue("U_RELPARNAME", variable5.Offset, objDT.GetValue("U_LEGALNAME", 0).ToString());
        ...
        public static void openLegalizationForm(SAPbouiCOM.MenuEvent pVal)
        {
            ...
            try
            {
                SAPbouiCOM.Form objForm = MainObject.Instance.B1Application.OpenForm(SAPbouiCOM.BoFormObjectEnum.fo_UserDefinedObject, "HCO_T1PTC300", "");
        ...
        public static void configureLegalizationForm(string FormUID, bool ReloadCombos)
        {
            ...
            try
            {
                if (FormUID.Trim().Length > 0)
                {
                    ...
                    if (ReloadCombos)
                    {
                        objCombo = (ComboBox) objForm.Items.Item("cmbSeries").Specific;
                        objCombo.ValidValues.LoadSeries("HCO_T1PTC300", SAPbouiCOM.BoSeriesMode.sf_Add);
            ...
            try
            {
                ...
                if (clearFilter)
                {
                    ...
                    if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE)
                    {
                        ...
                        {
                            strPC = oEvent.SelectedObjects.GetValue("Code", 0).ToString();
                            if (strPC.Trim().Length > 0)
                            {
                                oDBDS = objForm.DataSources.DBDataSources.Item("@HCO_T1PTC300");
        ...
        private static PC getPCInfo(string strPCCode)
        {
            ...
            try
            {
                ...
                objFilter = (GeneralDataParams)objPCObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                objFilter.SetProperty("Code", strPCCode);
                objPCInfo = objPCObject.GetByParams(objFilter);
                objPC.AvailableValue = double.Parse(objPCInfo.GetProperty("U_AVVALUE").ToString());
                objPC.ControlAccount = objPCInfo.GetProperty("U_CTRLACCT").ToString();
                objPC.isPosted = objPCInfo.GetProperty("U_ISPOSTED").ToString() == "Y" ? true : false; ;
                objPC.Name = objPCInfo.GetProperty("Name").ToString();
                objPC.PCAccount = objPCInfo.GetProperty("U_PCACCOUNT").ToString();
                objPC.Remark = objPCInfo.GetProperty("U_REMARK").ToString();
                objPC.ThirdParty = objPCInfo.GetProperty("U_TERRELA").ToString();
                objPC.Value = double.Parse(objPCInfo.GetProperty("U_VALUE").ToString());
        ...
        private static PCLegalizationFormCache getPCLegalizationInfo(int intLegalizationDocEntry)
        {
            ...
            try
            {
                ...
                objFilter = (GeneralDataParams)objPCLegalizationObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                ...
                objLegalizationFormCache.DocNum = int.Parse(objPCLegalizationInfo.GetProperty("DocNum").ToString());
                objLegalizationFormCache.Series = int.Parse(objPCLegalizationInfo.GetProperty("Series").ToString());
                ...
                objLegalizationFormCache.isPosted = objPCLegalizationInfo.GetProperty("U_ISPOSTED").ToString() == "Y" ? true : false;
                objLegalizationFormCache.JournalEntries = new List<PCJournalEntries>();
                objLegalizationFormCache.PCValue = double.Parse(objPCLegalizationInfo.GetProperty("U_VALUE").ToString());
                objLegalizationFormCache.pettyCash = new PC();
                string strPTCode = objPCLegalizationInfo.GetProperty("U_PTCODE").ToString();
                objLegalizationFormCache.pettyCash = getPCInfo(strPTCode.Trim());
                objLegalizationFormCache.remarks = objPCLegalizationInfo.GetProperty("Remark").ToString();
                objLegalizationFormCache.TotalValue = double.Parse(objPCLegalizationInfo.GetProperty("U_TOTVALUE").ToString());


                objPCLegalizationLines = objPCLegalizationInfo.Child("HCO_T1PTC301");
                for (int i = 0; i < objPCLegalizationLines.Count; i++)
                {
                    ...
                    string strConcept = objPCLegalizationLineInfo.GetProperty("U_CONCEPT").ToString();
                    if (strConcept.Trim().Length > 0)
                    {
                        ...
                        objPCConceptLine.Date = DateTime.Parse(objPCLegalizationLineInfo.GetProperty("U_DATE").ToString());
                        objPCConceptLine.Description = objPCLegalizationLineInfo.GetProperty("U_DESCRIPTION").ToString();
                        objPCConceptLine.DIM1 = objPCLegalizationLineInfo.GetProperty("U_DIM1").ToString();
                        objPCConceptLine.DIM2 = objPCLegalizationLineInfo.GetProperty("U_DIM2").ToString();
                        objPCConceptLine.DIM3 = objPCLegalizationLineInfo.GetProperty("U_DIM3").ToString();
                        objPCConceptLine.DIM4 = objPCLegalizationLineInfo.GetProperty("U_DIM4").ToString();
                        objPCConceptLine.DIM5 = objPCLegalizationLineInfo.GetProperty("U_DIM5").ToString();
                        objPCConceptLine.LineTotal = double.Parse(objPCLegalizationLineInfo.GetProperty("U_LINETOT").ToString());
                        objPCConceptLine.ProfitCenter = objPCLegalizationLineInfo.GetProperty("U_DIM1").ToString();
                        objPCConceptLine.Project = objPCLegalizationLineInfo.GetProperty("U_PROJECT").ToString();
                        objPCConceptLine.ThirdParty = objPCLegalizationLineInfo.GetProperty("U_TERRELA").ToString();
                        objPCConceptLine.TotalBeforeTaxes = double.Parse(objPCLegalizationLineInfo.GetProperty("U_VALUE").ToString());
                        objPCConceptLine.VAT = double.Parse(objPCLegalizationLineInfo.GetProperty("U_VAT").ToString());
                        objPCConceptLine.WHTax = double.Parse(objPCLegalizationLineInfo.GetProperty("U_WHTAX").ToString());
        ...
        public static PCConcept getConceptInformation(string strCode)
        {
            ...
            try
            {
                ...
                objFilter = (GeneralDataParams)objPCConceptObject.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams);
                objFilter.SetProperty("Code", strCode);
                objPCConceptInfo = objPCConceptObject.GetByParams(objFilter);

                objConcept = new PCConcept();
                
                objConcept.Account = objPCConceptInfo.GetProperty("U_ACCTCODE").ToString();
                objConcept.Code = objPCConceptInfo.GetProperty("Code").ToString();
                objConcept.Name = objPCConceptInfo.GetProperty("Name").ToString();
                objConcept.ValidThirdparty = new List<PCConceptThirdParty>();
                objConcept.ValidWHTax = new List<PCConceptWHTax>();
                objConcept.VATCode = objPCConceptInfo.GetProperty("U_TAXCODE").ToString();
                

                objThirdpartyChild = objPCConceptInfo.Child("HCO_T1PTC202");
                for (int i = 0; i < objThirdpartyChild.Count; i++)
                {
                    PCConceptThirdParty objTP = new PCConceptThirdParty();
                    objTP.Code = objThirdpartyChild.Item(i).GetProperty("U_RELPAR").ToString();
                ...
                objWHTaxChild = objPCConceptInfo.Child("HCO_T1PTC201");
                for (int i = 0; i < objWHTaxChild.Count; i++)
                {
                    string strWCode = objWHTaxChild.Item(i).GetProperty("U_WTCODE").ToString();
                    ...
                    if (objForm.Mode == SAPbouiCOM.BoFormMode.fm_ADD_MODE || objForm.Mode == SAPbouiCOM.BoFormMode.fm_UPDATE_MODE)
                    {
                        ...
                        if (oEvent.SelectedObjects != null)
                        {
                            ...
                            if (objConcept != null)
                            {
                                ...
                                oDBLinesDS = objForm.DataSources.DBDataSources.Item("@HCO_T1PTC301");
        ...
        public static void refreshFormValues(SAPbouiCOM.ItemEvent pVal)
        {
            ...
            {
                objForm = MainObject.Instance.B1Application.Forms.Item(pVal.FormUID);
                objDBDS = objForm.DataSources.DBDataSources.Item("@HCO_T1PTC300");
                ...
                if (objLegalizationFormCache != null)
                {
                    ...
                    objDBDSLines = objForm.DataSources.DBDataSources.Item("@HCO_T1PTC301");
