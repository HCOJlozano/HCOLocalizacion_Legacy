    ...
    public class Operations
    {
        ...
        public static bool addUDOInfo(object UDOInfo, string UDOName)
        {
            ...
            try
            {
                    ...
                    headerInfo = (GeneralData)UDOService.GetDataInterface(GeneralServiceDataInterfaces.gsGeneralData);
        ...
        public static bool addupdTransactionCode(string TransCode, string TransCodeDescription)
        {
            ...
            {
                objCompanyService = MainObject.Instance.B1Company.GetCompanyService();
                objTransCodeService = (TransactionCodesService)objCompanyService.GetBusinessService(ServiceTypes.TransactionCodesService);
                objParamas = (TransactionCodeParams)objTransCodeService.GetDataInterface(TransactionCodesServiceDataInterfaces.tcsTransactionCodeParams);
            ...
            catch(COMException comEx)
            {
                ...
                {
                    objTransCode = (TransactionCode)objTransCodeService.GetDataInterface(TransactionCodesServiceDataInterfaces.tcsTransactionCode);
        ...
        public static double roundValue(double LocalAmount, RoundingContextEnum B1Context)
        {
            ...
            try
            {
                ...
                DecimalData objDecimalData = (DecimalData)objCompanyService.GetDataInterface(CompanyServiceDataInterfaces.csdiDecimalData);
        ...
        public static double getSCValue(double LocalAmount, DateTime date, out string Message, RoundingContextEnum B1Context)
        {
            ...
            try
            {
                if (MainObject.Instance.B1AdminInfo.SystemCurrency != MainObject.Instance.B1AdminInfo.LocalCurrency)
                {
                    objBob = (SBObob)MainObject.Instance.B1Company.GetBusinessObject(BoObjectTypes.BoBridge);
                    objRS = objBob.GetCurrencyRate(MainObject.Instance.B1AdminInfo.SystemCurrency, date);
                    double dbRate = double.Parse(objRS.Fields.Item(0).Value.ToString());

                    objCompanyService = MainObject.Instance.B1Company.GetCompanyService();

                    DecimalData objDecimalData =
                        (DecimalData)objCompanyService.GetDataInterface(CompanyServiceDataInterfaces.csdiDecimalData);
                    objDecimalData.Context = B1Context;
                    objDecimalData.Currency = MainObject.Instance.B1AdminInfo.SystemCurrency;
        ...
        public static double getWTAmountLC(string WTCode, double dbAmount)
        {
            ...
            try
            {
                ...
                objWHT = (WithholdingTaxCodes)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oWithholdingTaxCodes);
        ...
        public static double getTaxAmountLC(string TaxCode, double dbAmount)
        {
            ...
            try
            {
                objVAT = (SalesTaxCodes)MainObject.Instance.B1Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oSalesTaxCodes);
        ...
        public static bool isAccountAsociated(string AccountCode)
        {
            ...
            try
            {
                objAcct = (ChartOfAccounts)MainObject.Instance.B1Company.GetBusinessObject(BoObjectTypes.oChartOfAccounts);
